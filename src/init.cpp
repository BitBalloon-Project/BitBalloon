...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitballoon-project/bitballoon>";
    const std::string URL_WEBSITE = "<https://bitballoon.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Bitballoon version %s\n", FormatFullVersion());
}
