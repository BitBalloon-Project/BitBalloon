...
{
    const char* pszTimestamp = "BitBalloon Rocks";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 60 * 60 * 60 * 60; // 150 days
        ...
        genesis = CreateGenesisBlock(1537400616, 2086810936, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa1ae1b62b2a70496caaf7513e0ef92503eaca0a5125e2a8da917a2c984d04790"));
        ...
        //vSeeds.emplace_back("seed-a.bitballoon.loshan.co.uk", true);
        //vSeeds.emplace_back("dnsseed.thrasher.io", true);
        //vSeeds.emplace_back("dnsseed.bitballoontools.com", true);
        //vSeeds.emplace_back("dnsseed.bitballoonpool.org", true);
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0xf4, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0xf4, 0x88, 0xAD, 0xE4};
        ...
        checkpointData = (CCheckpointData) {
            {
                {  0, uint256S("0xa1ae1b62b2a70496caaf7513e0ef92503eaca0a5125e2a8da917a2c984d04790")},
            }
        };

        chainTxData = ChainTxData{
            // Data as of block 59c9b9d3fec105bdc716d84caa7579503d5b05b73618d0bf2d5fa639f780a011 (height 1353397).
            1537400616, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 4497627, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
