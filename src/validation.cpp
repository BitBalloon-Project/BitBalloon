...
#if defined(NDEBUG)
# error "Bitballoon cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Bitballoon Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s BBL additional fees, %d delta bytes\n",
